<?php require_once 'header.php'; ?>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            <a href="/products/0"><button type="submit" class="btn btn-success"><?php t('Create');?></button></a>
          </div>
        </div>
        <div class="col-md-12">
          <div class="card">
            ...
            <?php
              ...
              $api = new ApiClient();
              $api->get_filter('/zazu_good/', '(is_gift=0)');
              ...
              <?php } else {
                ...
                <?php } else {
                  ...
                  $table->set_custom_columns([
                      2=>['header'=>'is_enabled', 'title'=>tr('Enabled'), 'type'=>'double-selection', 'on-1'=>tr('Yes'), 'on-0'=>tr('No')]
                  ]);
